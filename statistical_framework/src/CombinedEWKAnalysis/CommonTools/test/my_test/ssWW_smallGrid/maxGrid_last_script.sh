...
cp /storage/9/mneukum/rwgt_final/files/root_cut/ssWW_KC_maxGrid_to_FS0.root ./ssWW_smallGrid_fs0.root
...
cp /storage/9/mneukum/rwgt_final/files/root_cut/ssWW_KC_maxGrid_to_FS1.root ./ssWW_smallGrid_fs1.root
...
cp /storage/9/mneukum/rwgt_final/files/root_cut/ssWW_KC_maxGrid_to_FM0.root ./ssWW_smallGrid_fm0.root
...
cp /storage/9/mneukum/rwgt_final/files/root_cut/ssWW_KC_maxGrid_to_FM1.root ./ssWW_smallGrid_fm1.root
...
cp /storage/9/mneukum/rwgt_final/files/root_cut/ssWW_KC_maxGrid_to_FM7.root ./ssWW_smallGrid_fm7.root
...
cp /storage/9/mneukum/rwgt_final/files/root_cut/ssWW_KC_maxGrid_to_FT0.root ./ssWW_smallGrid_ft0.root
...
cp /storage/9/mneukum/rwgt_final/files/root_cut/ssWW_KC_maxGrid_to_FT1.root ./ssWW_smallGrid_ft1.root
...
cp /storage/9/mneukum/rwgt_final/files/root_cut/ssWW_KC_maxGrid_to_FT2.root ./ssWW_smallGrid_ft2.root
