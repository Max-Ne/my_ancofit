...
cp /storage/9/mneukum/test/pythia_output_to_ATGCRooStats/ready_to_fit_ssWW_KC_maxGrid_2_fs0.root ./ssWW_smallGrid_fs0.root
python ./doFit.py --config=ssWW_smallGrid_fs0_config
cp /storage/9/mneukum/test/pythia_output_to_ATGCRooStats/ready_to_fit_ssWW_KC_maxGrid_2_fs1.root ./ssWW_smallGrid_fs1.root
python ./doFit.py --config=ssWW_smallGrid_fs1_config
cp /storage/9/mneukum/test/pythia_output_to_ATGCRooStats/ready_to_fit_ssWW_KC_maxGrid_2_fm0.root ./ssWW_smallGrid_fm0.root
python ./doFit.py --config=ssWW_smallGrid_fm0_config
cp /storage/9/mneukum/test/pythia_output_to_ATGCRooStats/ready_to_fit_ssWW_KC_maxGrid_2_fm1.root ./ssWW_smallGrid_fm1.root
python ./doFit.py --config=ssWW_smallGrid_fm1_config
cp /storage/9/mneukum/test/pythia_output_to_ATGCRooStats/ready_to_fit_ssWW_KC_maxGrid_2_fm7.root ./ssWW_smallGrid_fm7.root
python ./doFit.py --config=ssWW_smallGrid_fm7_config
cp /storage/9/mneukum/test/pythia_output_to_ATGCRooStats/ready_to_fit_ssWW_KC_maxGrid_2_ft0.root ./ssWW_smallGrid_ft0.root
python ./doFit.py --config=ssWW_smallGrid_ft0_config
cp /storage/9/mneukum/test/pythia_output_to_ATGCRooStats/ready_to_fit_ssWW_KC_maxGrid_2_ft1.root ./ssWW_smallGrid_ft1.root
python ./doFit.py --config=ssWW_smallGrid_ft1_config
cp /storage/9/mneukum/test/pythia_output_to_ATGCRooStats/ready_to_fit_ssWW_KC_maxGrid_2_ft2.root ./ssWW_smallGrid_ft2.root
